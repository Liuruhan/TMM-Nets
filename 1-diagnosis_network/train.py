...
if __name__ == "__main__":
    # model_list = ['vgg19', 'vgg19_bn', 'inception_v3']#'densenet121', 'vgg16', 'vgg16_bn',
    model_list = ['resnet18', 'resnet34', 'resnet50','wide_resnet50_2', 'mobilenet_v2','squeezenet1_0', 'squeezenet1_1']
                  #['resnet18', 'resnet34', 'resnet50','wide_resnet50_2',
                  #'densenet121',
                  # 'vgg16', 'vgg16_bn', 'vgg19', 'vgg19_bn',
                  # 'mobilenet_v2',
                  # 'inception_v3',
                  # 'squeezenet1_0', 'squeezenet1_1']#'mobilenet_v2', 'inception_v3', 'densenet121', 'densenet161']
    #'resnet18',
           #'resnet18', 'resnet34',
    ...
    tr_dir_img = "./fp_aug_dataset/train/"
    val_dir_img = "./fp_aug_dataset/test/"
    ...
    regular_model_path = './results/regular_fundus_training/'
    model_num_list = ['4', '4', '4', '4', '4', '3', '26']
    # regular_model_path = './DR/checkpoints/'
    # model_num_list = ['2', '9', '4']#'11', '15', '3',
    for i in range(len(model_list)):
        load_path = regular_model_path+model_list[i]+'/'+model_list[i]+'_epoch'+model_num_list[i]+'.pth'
        print(model_list[i])
        # load_path = None
        train_net(model_list[i], args.num_classes, train_loader, val_loader, 2, load_path)
